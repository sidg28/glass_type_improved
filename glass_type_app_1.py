...
if classifier == 'Logistic Regression':
    ...
    max_iter_input = st.sidebar.slider("Maximum Iteration Value", 100, 500,step = 10)
        
    if st.sidebar.button('Classify'):
        st.subheader("Logistic Regressionr")
        model = LogisticRegression(C = c_input, max_iter = max_iter_input)
